# Source fixtures — real captured API responses
...
| `usajobs-401.raw.json` | `https://data.usajobs.gov/api/search?Keyword=software&ResultsPerPage=2` | `GET` | 2026-09-19T18:41:50Z | 401 |
